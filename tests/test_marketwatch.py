...
urls = [
    ...
    'https://www.marketwatch.com/story/microsoft-bets-on-the-metaverse-with-69-billion-deal-for-activision-blizzard-11642515657?mod=home-page'
]
...
filepath_test = '/newspapers/test_marketwatch.json'
